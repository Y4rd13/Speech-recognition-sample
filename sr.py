...
if __name__ == "__main__":
    p1 = multiprocessing.Process(
        target=chunks_speech_recognition, args=[1000, -60, True, 'results_p1.txt', 'confidence_p1.txt', 'chunks_p1'])
    p2 = multiprocessing.Process(
        target=chunks_speech_recognition, args=[1000, -60, True, 'results_p2.txt', 'confidence_p2.txt', 'chunks_p2'])
